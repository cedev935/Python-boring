...
**注：有不明白的请先看本文最好先看QA，如果无法解决请到[这里](https://github.com/redapple0204/my-boring-python/pull/177)提出你的问题（因为原issue含有太多个人信息已经被关闭）或者在贴吧上@redapple0204 来找我也或者发邮件到redapple02041@gmail.com（不经常处理）**
...
最近总是有人用我这个vps滥用下载各种文件，各位，vps也是要钱的，硬盘也不是无限大，流量也不是无限的，拜托先试试别的办法行吧？像今天晚上就是最典型的，用这个办法下载啦一大堆MAC的东西，直接把我vps硬盘占用100%！而且流量耗费了将近100G！所以说，鉴于以上几种情况，又为了防止小白滥用本下载站来乱下载东西，所以现在关闭服务器，只给有github账号的人使用，如果您需要使用，请在[这里](https://github.com/redapple0204/my-boring-python/pull/177)提出申请，申请格式如下。
...
现在打开http://138.68.48.194:2333/ 这个网站
...
这个时候打开http://138.68.48.194:10000/lua/network_stats.lua （用户名密码均为download）
...
然后转到http://138.68.48.1945:10000/lua/network_stats.lua （用户名密码均为download）查看下载进度，注意看这个traffic底下那栏，记数据为b，这个时候你的文件下载了多少的公式就是（b-a）G。然后还可以通过底下的仪表盘来看速度（1mbps近似取100k，以此类推）
...
这个时候请到http://138.68.48.194.35:80 里面的download文件夹下载你下载的文件，也可以到ftp://138.68.48.194 来下载（较慢）
...
然后解压，复制到c:\windows\system32里，然后打开http://138.197.219.35:80 右键你要下载的文件，获取链接，然后打开cmd，输入
