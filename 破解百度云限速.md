...
-------------------------------
>方法三最新可用时间：2017-03-25（据百度贴吧的吧友汇报出现了404错误，但我这里没法使用pcs。相关的issue在[这里](https://github.com/GangZhuo/BaiduPCS/issues/163)），而且每隔几秒速度变为0，非常不稳定，并且更新版本以后对windows支持极差（似乎只有win10可用），linux还好。所以不建议使用。
-------------------------------
