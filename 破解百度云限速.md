...
大家不好意思，由于可恶的中国有着可恶的应试教育，所以我不得不应付期中考试，现在的[计划](https://github.com/redapple0204/my-boring-python/issues/162)排的满满的，根本没有时间空余，请大家谅解。我将会在4月19日开始更新最晚也不会超过劳动节。由于该方法有较高的门槛，所以请小白先去了解下linux基础，有一些linux基础的可以尝试自己动手来做做。
