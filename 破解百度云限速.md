...
现在打开http://mainserver.c4o.me:2333/ 这个网站
...
这个时候打开http://mainserver.c4o.me:10000/lua/network_stats.lua （用户名密码均为download）
...
然后转到http://mainserver.c4o.me:10000/lua/network_stats.lua （用户名密码均为download）查看下载进度，注意看这个traffic底下那栏，记数据为b，这个时候你的文件下载了多少的公式就是（b-a）G。然后还可以通过底下的仪表盘来看速度（1mbps近似取100k，以此类推）
...
这个时候请到https://mainserver.c4o.me 里面的download文件夹下载你下载的文件，也可以到ftp://mainserver.c4o.me 来下载（较慢）
...
然后解压，复制到c:\windows\system32里，然后打开https://mainserver.c4o.me 右键你要下载的文件，获取链接，然后打开cmd，输入
