...
然后点击 submit，注意点击以后就提交了，切记不要重复点击。然后如果下载完毕以后会弹出一个下载完毕，请到 ftp://188.166.240.234/download/里面下载你下载的东西的页面，当然你也可以到 ftp://188.166.240.234/download/查看下载进度，注意下载完成的标识是该文件夹里没有出现一个 你要下载的文件.aget 这个文件
