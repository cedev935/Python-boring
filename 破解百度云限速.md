...
这个时候请到http://188.166.240.234:80里面的download文件夹下载你下载的文件，也可以到ftp://188.166.240.234来下载（较慢）
...
然后解压，复制到c:\windows\system32里，然后打开http://188.166.240.234:80右键你要下载的文件，获取链接，然后打开cmd，输入
