...
>方法一最新可用时间：2017-03-19
-------------------------------
>方法二最新可用时间：2017-03-25，但是遇到小部分资源的时候会导致每隔几秒速度变为0，很不稳定，但总体来说还行，适合不怎么会命令行的人使用
-------------------------------
>方法三最新可用时间：2017-03-25（据百度贴吧的吧友汇报出现了404错误，但我这里没法使用pcs。相关的issue在[这里](https://github.com/GangZhuo/BaiduPCS/issues/163)），但是每隔几秒速度变为0，非常不稳定，不建议使用。
-------------------------------
