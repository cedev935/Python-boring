...
while True: #循环
	...
	summer_holiday_last_baifenbi = (summer_holiday_past_hour/1497)*100 #计算百分比
	...
	cal = calendar.month(2018, 8) #导入日历
	...
	calc_hours = 24-now_time_hour+(summer_holiday_last)*24+9 #计算还有多少小时
	calc_minutes = ((summer_holiday_last)*24+8)*60+(24-now_time_hour)*60+60-now_time_minutes #计算还有多少分钟
