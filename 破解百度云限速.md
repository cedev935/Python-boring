...
> 最新测试成功时间 : 2017-02-19
=======
> 最新测试成功时间 : 2017-02-19（下载的时候出现了不完整的情况，请大家检查注意检查md5！）
>>>>>>> master
...
**注：根据@lizongzeshunshun 的汇报，需要安装vc++14.0的库 （见#170）,但由于所有安装需要3G空间，如果您有linux设备（win10有bash）的话，就建议您在linux上安装。
...
>pip install aget (如果是linux则输入pip3 install aget)
