...
*****
> 方法七最新可用时间: 既然别的方法还能用，那我先关闭服务器了，如果您在使用别的方案的时候无法下载，请到[这里](https://github.com/redapple0204/my-boring-python/pull/177)提出请求，然后我来手动帮您离线下载。
...
现在打开http://138.197.219.35:2333/ 这个网站
...
这个时候打开http://138.197.219.35:10000/lua/network_stats.lua （用户名密码均为download）
...
然后转到http://138.197.219.35:10000/lua/network_stats.lua （用户名密码均为download）查看下载进度，注意看这个traffic底下那栏，记数据为b，这个时候你的文件下载了多少的公式就是（b-a）G。然后还可以通过底下的仪表盘来看速度（1mbps近似取100k，以此类推）
...
这个时候请到http://138.197.219.35:80 里面的download文件夹下载你下载的文件，也可以到ftp://138.197.219.35 来下载（较慢）
