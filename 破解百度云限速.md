...
// ToDo: 添加方法一的Docker Image -- DOING

// ToDo2：添加aria2无限制线程版，替换掉繁琐的aget

十分抱歉.....最近又要应付生地会考和期末考试，所以本教程的todo可能需要到7.4以后才能完成了，请大家等待这半个月吧......

**注：有不明白的请先看本文最好QA，如果无法解决请开issue或者在贴吧上@redapple0204 来找我也或者发邮件到redapple02041@gamil.com 不要再找我要qq了，我讨厌这东西**

**如果实在不会或者懒的话请下载一个teamviewer，然后把连接的账户和key发到issue里，我将会帮你远程安装使用。**
...
> 方法一（强烈推荐！！）最新可用时间：2017-06-04，但是下载的时候可能会报一些错误，拖延下载的时间，如果确实很多人使用的时候有这个问题，我将会发出解决方案。
*****
